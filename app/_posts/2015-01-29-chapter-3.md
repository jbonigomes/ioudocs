...
Advantages of git and the workflow with git flow

### Node.js

yeoman, bower (usemin and wiredep) and grunt in a nutshell, the main build, cssmin, concat, htmlmin, jshint, uglify

### Angular js

mention the angular local storage

### Ionic

ngCordova and angular ui router
